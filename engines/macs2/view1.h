...
private:
	...
	uint16_t GetVerticalOffset() const;
...
public:
	...
	Macs2::Sprite *GetUISprite(uint32_t offset);

	// fn0037_3737 proc
	void DrawHorizontalBorderHighlight(const Common::Point &pos, int16 width, uint32_t spriteAddress, Graphics::ManagedSurface &s);
	// 0037h:3876h
	void DrawVerticalBorderHighlight(const Common::Point &pos, int16 height, uint32_t spriteAddress, Graphics::ManagedSurface &s);
