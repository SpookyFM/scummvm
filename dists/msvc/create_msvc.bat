...
echo.
create_project ..\.. --enable-all-engines --msvc --msvc-version 17
goto done
...
echo.
create_project ..\.. --msvc --msvc-version 17
goto done
...
echo.
create_project ..\.. --tools --msvc --msvc-version 17
goto done
...
echo.
create_project ..\.. --tests --msvc --msvc-version 17
goto done
